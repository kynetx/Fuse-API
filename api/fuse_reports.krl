...
>>;
	...
	fleet_size = fleet_details.length();
	readable_total_fleet_size = fleet_size == 1 => fleet_size + " vehicle"
                                                     | fleet_size + " vehicles";
...
<tr><td bgcolor="ffffff" style="#{vehicle_table_row_style}">Fleet size: #{readable_total_fleet_size} </td></tr>
